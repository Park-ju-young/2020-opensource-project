    ...
    request.post({
        ...
        json:{
            ...
            "messages" :[
                ...
                {
                    "type":"text",
                    "text": "식품첨가물 정보 알리미가 제공하는 식품첨가물 정보는 식품의약품안전처의 공신력 있는 자료를 바탕으로 만들어졌습니다."
                },
...
app.post('/hook', function (req, res) {
    ...
    else if(message_text == '모드')
    {
        ...
        {
            var msg = "자세한 결과 보기 모드입니다. 첨가물의 정보를 확인하실 수 있습니다."
        }
